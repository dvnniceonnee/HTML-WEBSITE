            ...
            <div id="carouselExampleCaptions" class="carousel slide carousel-dark">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="img/promocoes/aspirador.webp" class="d-block w-100" alt="...">
                  ...
                  <div class="carousel-item">
                    <img src="img/promocoes/comoda.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="carousel-item">
                    <img src="img/promocoes/humidificador.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                  ...
                  <div class="carousel-item">
                    <img src="img/promocoes/panela.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Third slide label</h5>
                      <p>Some representative placeholder content for the third slide.</p>
                    </div>
